...
const KELOMPOK: { judul: string; items: { k: string; label: string; hint?: string; kunciTetap?: boolean; kunciSaldo?: boolean }[] }[] = [
  {
    judul: 'Identitas', items: [
      ...
      { k: 'alamat', label: 'Alamat', hint: 'Dipakai di header laporan WA & PDF' },
      { k: 'nama_bendahara', label: 'Nama bendahara' },
      { k: 'rekening', label: 'Rekening / DANA', hint: 'Dipakai di pesan tagihan' },
    ],
  },
  {
    judul: 'Aturan', items: [
  ...
  return (
    <div className="p-4 pb-24">
      ...
      <div className="rounded-2xl bg-white border mb-4" style={{ borderColor: 'var(--line)' }}>
        <Link href="/anggota" className="flex items-center gap-3 p-3.5 border-b"
        ...
        <div className="flex items-center gap-3 p-3.5 opacity-50">
          <span className="w-8 h-8 rounded-lg grid place-items-center text-sm"
      ...
      <p className="text-[10.5px] text-center mt-3 leading-relaxed" style={{ color: 'var(--muted)' }}>
        Semua angka & nama di sini bebas diubah.<br />
